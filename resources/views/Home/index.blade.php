...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
    ...
    <section class="success" id="about">
        <div class="container">
            ...
            <div class="row">
                 <form action="Registrarse.php" method="post" name="frm2">
    <table align="center">
    <tr height="50">
    <td><input name="txtNombre" class="form-control" style="width: 400px;height: 45px;" placeholder="Ingresa Nombre" type="text" /></td>
    <td></td>
    ...
    <tr height="50">
    <td><input name="txtCorreo" class="form-control" style="width: 400px;height: 45px;" placeholder="Ingresa Correo" type="text" /></td>
    <td></td>
    </tr>
    <tr height="100">
    <td><input name="txtFecha" class="form-control" style="width: 400px;height: 45px;" placeholder="Ingresa Fecha Nacimiento" type="text" /></td>
    <td></td>
    </tr>
    <tr height="50">
    <td><input name="btnLogin" class="btn btn-primary" style="width: 100px;height: 35px; type="submit" value="Login" /></td>
    <td></td>
    </tr>
    <tr>
    <td></td>
